...
function renderImages(imageArray) {
    ...
    imageArray.forEach((image, index) => {
        ...
        img.src = image.src; // Preload image immediately
        img.alt = image.alt;
        img.loading = 'lazy'; // Enable lazy loading for subsequent slides
        ...
        if (index === 0) {
            div.style.display = "block"; // Show the first slide initially
        }
    });
}
...
//         const img = document.createElement('img');
//         img.src = image.src; // Load the image directly
//         img.alt = image.alt;
//         img.loading = 'lazy';
